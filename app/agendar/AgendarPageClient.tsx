...
export default function AgendarPageClient({ nomeUsuario }: { nomeUsuario: string }) {
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-slate-600">Confirme data/hora e acompanhe o status das solicitações.</p>
      </div>
